    ...
    return (
        <div className='bg-gray-200 dark:bg-darkNavBg'>
            <div className='pt-3 px-2'>
                <div className='text-2xl font-antipasto font-bold tracking-wider text-violet-500 dark:text-violet-600'>Welcome to the Artyst Store</div>
            ...
            {/* Merch */}
            <CartModal open={cartOpen} onClose={handleCartClose} cartList={props.common.user.cart} fetchStoreImages={fetchStoreImages} handleCartRemove={props.handleRemoveFromCart} />
        </div>
    )
}
