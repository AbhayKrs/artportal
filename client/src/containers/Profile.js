...
import { getUserDetails, clearUserProfile } from '../store/actions/common.actions';
                        ...
                        <div className="px-6">
                            <div className="flex flex-wrap justify-center mb-7">
                                <div className="w-full w-4/12 px-4">
                                    <div className="flex justify-center pt-4 pt-8">
                                ...
                                <div className="w-full lg:w-3/12 px-4 flex justify-center">
                                    <div className="relative">
                                        <img src={fetchUserImages(props.viewed_user.avatar.icon)} className="h-auto align-middle absolute -m-32 -ml-28 max-w-[15rem]" />
                                    </div>
                                </div>
                            ...
                            <div className='flex space-x-3 py-3 items-center'>
                                <div onClick={() => setActiveView('explore')} className={`text-lg font-semibold ${activeView === 'explore' ? 'text-violet-400 dark:text-violet-500' : 'text-gray-700 dark:text-gray-400'} font-caviar cursor-pointer`}>Portfolio</div>
                            ...
                            {activeView === 'explore' && props.viewed_user.explore && <div className='flex flex-row'>
                                <Masonry>
