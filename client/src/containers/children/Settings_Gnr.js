...
import { fetchLocations } from '../../store/actions/common.actions';


export const Settings_Gnr = (props) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(Settings_Gnr)