...
const Cart = (props) => {
                        ...
                        <div className='flex sm:flex-row flex-col gap-5 py-2 font-caviar text-md'>
                            ...
                            <div className='flex flex-col items-end ml-auto space-y-2'>
                                <div className="flex flex-row h-10 rounded-lg relative bg-transparent mt-1">
                                    <button onClick={() => props.handleCartAdd(cartItem)} className="bg-slate-300 dark:bg-neutral-700 h-full w-10 rounded-l cursor-pointer flex items-center justify-center">
                                    ...
                                    <button onClick={() => props.handleRemoveFromCart(cartItem)} className="bg-slate-300 dark:bg-neutral-700 h-full w-10 rounded-r cursor-pointer flex items-center justify-center">
    ...
    return (
        <div className='main-container bg-gray-200 dark:bg-darkNavBg flex w-full justify-center'>
