...
import { IoClose, IoMenu, IoSunny, IoSettingsSharp } from "react-icons/io5";
...
const Header = (props) => {
    ...
    return (
        <nav className='fixed top-0 z-50 bg-slate-200 w-full dark:bg-darkBg'>
            {props.betaMsg && <div className='relative flex flex-row w-full py-1.5 justify-center bg-amber-500 font-caviar font-bold text-xs tracking-wide'>
            ...
            <div className='flex flex-row justify-between items-center py-2 px-3'>
                <div className='flex flex-row space-x-6'>
                    <Link to='/' onClick={() => setMobileMenu(false)} className='flex items-center justify-center'>
                        <img loading='lazy' className='h-8 w-8 hover:cursor-pointer' src={Artyst_logo} alt='Artyst' />
                    </Link>
                    <Link to='/explore' className='relative group hidden sm:flex self-center text-neutral-800 dark:text-gray-300 rounded-md text-normal font-caviar font-bold'>
                        Explore
                        <div className={`absolute ${activeRoute.includes('/explore') ? 'block' : 'hidden group-hover:block'} h-1 w-2/6 bottom-[-2px] left-0 text-2xl bg-violet-500`}></div>
                    </Link>
                    <Link to='/store' className='relative group hidden sm:flex self-center text-neutral-800 dark:text-gray-300 rounded-md text-normal font-caviar font-bold'>
                        Store
                        <div className={`absolute ${activeRoute.includes('/store') ? 'block' : 'hidden group-hover:block'} h-1 w-2/6 bottom-[-2px] left-0 text-2xl bg-violet-500`}></div>
                    </Link>
                </div>
                    ...
                    {props.common.isAuthenticated ?
                        <>
                            <Link to='/explore/new' className='relative self-center hover:cursor-pointer'>
                                <MdUpload className='h-7 w-7 text-neutral-800 dark:text-gray-300 hover:text-violet-500 dark:hover:text-violet-500' />
                            </Link>
                            <Link to='/store/cart' className='relative self-center rounded-md hover:cursor-pointer'>
                                <MdShoppingCart className='w-6 h-6 text-neutral-800 dark:text-gray-300 hover:text-violet-500 dark:hover:text-violet-500' />
                            ...
                            <Link to='/notifications' className='relative self-center hover:cursor-pointer'>
                                <AiFillNotification className='h-6 w-6 text-neutral-800 dark:text-gray-300 hover:text-violet-500 dark:hover:text-violet-500' />
                        ...
                        :
                        <>
                            <button onClick={() => props.handleHeaderDialogOpen('openLoginDialog')} className='h-fit self-center bg-neutral-800 dark:bg-gray-300 text-gray-200 dark:text-neutral-800 hover:bg-neutral-700 dark:hover:bg-gray-200 py-1 px-3 rounded-md font-caviar font-bold'>Login</button>
                            <button onClick={() => props.handleHeaderDialogOpen('openRegisterDialog')} className='h-fit self-center border border-gray-800 dark:border-gray-300 text-neutral-800 dark:text-gray-200 hover:bg-slate-300 dark:hover:bg-gray-300/10 py-1 px-3 ml-3 rounded-md font-caviar font-bold'>Signup</button>
                        </>
                    }
                    <Link to='/settings' className='relative self-center hover:cursor-pointer'>
                        <RiSettings4Fill className='h-6 w-6 text-neutral-800 dark:text-gray-300 hover:text-violet-500 dark:hover:text-violet-500' />
                    </Link>
                    ...
                    <div ref={userMenuRef} className='relative group'>
                        {props.common.isAuthenticated ?
                            <button onClick={() => setUserMenuActive(!userMenuActive)} className={`flex w-full m-auto p-1.5 justify-center items-center ${userMenuActive ? 'bg-slate-300 dark:bg-[#313135] rounded-md' : null}`} >
                                {props.user.avatar.icon.length > 0 && <img loading='lazy' alt='user' src={fetchUserImages(props.user.avatar.icon)} className='w-6 h-6 mx-auto' />}
                            </button>
                            :
                        ...
                        <div className={`container fixed ${props.betaMsg === true ? 'top-[4.75rem]' : 'top-[3.25rem]'} w-80 p-1 ${userMenuActive ? 'visible opacity-100' : 'invisible opacity-0'} bg-slate-300 dark:bg-[#313135] rounded-lg`} style={{ right: window.innerWidth >= 1024 ? '0.75rem' : '0.2rem' }}>
                            <div className='flex flex-col scrollbar overflow-auto p-1 pr-2 h-full' style={{ maxHeight: 'calc(100vh - 5rem)' }}>
                                <div className='flex flex-row items-center space-x-2 p-4'>
                                    ...
                                    <div className='flex flex-col'>
                                        <p className='text-gray-900 dark:text-gray-200 text-3xl font-caviar font-bold'>{props.user.name}</p>
                                        <div className='inline-flex flex-row items-center gap-1'>
                                            <p className='text-gray-900 dark:text-gray-200 text-sm font-caviar font-bold tracking-wide'>#{props.user.username}</p>
                                            ...
                                            <img loading='lazy' className='h-6 w-6' src={premium_logo} alt='Artyst' />
                                        </div>
                                    </div>
                                ...
                                <button onClick={() => { navigate('/premium'); setUserMenuActive(false) }} className='flex flex-row justify-center bg-slate-200 dark:bg-neutral-900 items-center gap-1 mb-1 py-1.5 px-3 rounded-md w-full'>
                                    <div className='flex items-center justify-center rounded-md'>
                                        <img loading='lazy' className='h-8 w-8' src={premium_logo} alt='Artyst' />
                                    </div>
                                    <p className='font-caviar text-sm font-bold text-gray-900 dark:text-gray-300'>Upgrade to Artyst Premium</p>
                                </button>
                                <div className='flex flex-row justify-between items-center rounded-md py-1 px-4'>
                                    <div className='flex flex-row gap-2 items-center'>
                                        ...
                                        <div>
                                            <p className='font-caviar font-bold dark:font-bold text-gray-900 dark:text-gray-300'>Tokens</p>
                                            <p className='font-caviar items-center font-bold dark:font-normal text-gray-900 dark:text-gray-300'>{props.user.tokens} tokens</p>
                                        </div>
                                    </div>
                                ...
                                <div className='flex flex-col'>
                                    <Link to={`/users/${props.user.id}`} onClick={() => setUserMenuActive(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-4 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                        ...
                                        <span className='text-normal font-caviar font-bold tracking-wider'>My Profile</span>
                                    </Link>
                                    <Link to={`/users/${props.user.id}/pins`} onClick={() => setUserMenuActive(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-4 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                        ...
                                        <span className='text-normal font-caviar font-bold tracking-wider'>My Pins</span>
                                    </Link>
                                    <Link to={`/users/${props.user.id}/space`} onClick={() => setUserMenuActive(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-4 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                        ...
                                        <span className='text-normal font-caviar font-bold tracking-wider'>My Space</span>
                                    </Link>
                                    <Link to={`/users/${props.user.id}/history`} onClick={() => setUserMenuActive(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-4 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                        ...
                                        <span className='text-normal font-caviar font-bold tracking-wider'>My History</span>
                                    </Link>
                                    <hr className='border-2 border-gray-400 dark:border-neutral-800 my-1.5 mx-2' />
                                    <Link to='/studio' onClick={() => setUserMenuActive(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-4 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                        ...
                                        <span className='text-normal font-caviar font-bold tracking-wider'>Artyst Studio</span>
                                    </Link>
                                    <Link to='/studio/earnings' onClick={() => setUserMenuActive(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-4 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-2'>
                                        ...
                                        <span className='text-normal font-caviar font-bold tracking-wider'>Earnings</span>
                                    </Link>
                                    <Link to='/studio/payments' onClick={() => setUserMenuActive(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-4 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                        ...
                                        <span className='text-normal font-caviar font-bold tracking-wider'>Billing & Payments</span>
                                    </Link>
                                    <button onClick={logout} className='flex items-center text-gray-900 dark:text-violet-500 py-1.5 px-4 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-2 rounded-md cursor-pointer'>
                                        <HiOutlineLogout className='h-6 w-6' />
                                        <span className='text-normal font-caviar font-bold tracking-wider'>Logout</span>
                                    </button>
                                </div>
                                <div className='flex flex-col'>
                                    <p className='font-caviar text-xs p-3 items-center font-bold dark:font-normal text-neutral-500 dark:text-gray-300'>
                                        Artyst Inc. <span className='text-sm'>&#169;</span> 2024. All rights reserved.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            {mobileMenu ?
                <div className='flex flex-col space-y-2 p-3 overflow-y-auto w-auto' style={{ height: 'calc(100vh - 3.75rem)' }}>
                    {props.common.isAuthenticated ?
                        <div className="flex flex-col gap-2 bg-gray-300 dark:bg-neutral-800 p-3 rounded-md">
                            <div className='flex flex-row justify-between'>
                                <div className='flex flex-row gap-2'>
                                    ...
                                    <div className='flex flex-col'>
                                        <p className='text-gray-900 dark:text-gray-200 text-3xl font-caviar font-bold'>{props.user.name}</p>
                                        <div className='inline-flex flex-row items-center gap-1'>
                                            <p className='text-gray-900 dark:text-gray-200 text-xs font-caviar font-bold tracking-wide'>#{props.user.username}</p>
                                            <svg className="stroke-current stroke-1 text-emerald-500 dark:text-emerald-600 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                            </svg>
                            ...
                            <button onClick={() => { navigate('/premium'); setMobileMenu(false) }} className='flex flex-row gap-1 justify-center bg-slate-200 dark:bg-neutral-700 items-center px-3 rounded-md'>
                                ...
                                <p className='font-caviar font-bold text-gray-900 dark:text-gray-300'>Upgrade to Artyst Premium</p>
                            </button>
                    ...
                    <div className='flex flex-row justify-between items-center rounded-md px-2'>
                        <p className='text-lg font-caviar font-bold text-gray-900 dark:text-gray-200 '>Theme</p>
                    ...
                    <div className='flex flex-col h-full'>
                        {props.common.isAuthenticated ?
                            <>
                                <Link to='/settings' onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                    ...
                                    <span className='text-lg font-caviar font-bold tracking-wider'>Settings</span>
                                </Link>
                                <hr className='border-2 border-gray-400 dark:border-neutral-800 my-1.5 mx-2' />
                                <Link to={`/users/${props.user.id}`} onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                    <PiUserBold className='h-5 w-5' />
                                    <span className='text-lg font-caviar font-bold tracking-wider'>My Profile</span>
                                </Link>
                                <Link to={`/users/${props.user.id}/pins`} onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                    <PiPushPinBold className='h-5 w-5' />
                                    <span className='text-lg font-caviar font-bold tracking-wider'>My Pins</span>
                                </Link>
                                <Link to={`/users/${props.user.id}/space`} onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                    <PiUsersThreeBold className='h-5 w-5' />
                                    <span className='text-lg font-caviar font-bold tracking-wider'>My Space</span>
                                </Link>
                                <Link to={`/users/${props.user.id}/history`} onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                    <MdOutlineHistory className='h-5 w-5' />
                                    <span className='text-lg font-caviar font-bold tracking-wider'>My History</span>
                                </Link>
                                <hr className='border-2 border-gray-400 dark:border-neutral-800 my-1.5 mx-2' />
                                <Link to='/studio' onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                    <PiChalkboardSimpleBold className='h-5 w-5' />
                                    <span className='text-lg font-caviar font-bold tracking-wider'>Artyst Studio</span>
                                </Link>
                                <Link to='/studio/earnings' onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-2'>
                                    <MdOutlineAttachMoney className='h-5 w-5' />
                                    <span className='text-lg font-caviar font-bold tracking-wider'>Earnings</span>
                                </Link>
                                <Link to='/studio/payments' onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                                    <MdOutlineReceiptLong className='h-5 w-5' />
                                    <span className='text-lg font-caviar font-bold tracking-wider'>Billing & Payments</span>
                                </Link>
                            </> : null}
                        <hr className='border-2 border-gray-400 dark:border-neutral-800 my-1.5 mx-2' />
                        <Link to='/about' onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                            ...
                            <span className='text-lg font-caviar font-bold tracking-wider'>About</span>
                        </Link>
                        <Link to='/help' onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                            ...
                            <span className='text-lg font-caviar font-bold tracking-wider'>Help</span>
                        </Link>
                        <Link to='/tos' onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                            ...
                            <span className='text-lg font-caviar font-bold tracking-wider'>Terms of Service</span>
                        </Link>
                        <Link to='/privacy' onClick={() => setMobileMenu(false)} className='flex items-center text-gray-900 dark:text-gray-200 py-1.5 px-2 hover:bg-gray-200 dark:hover:bg-neutral-700 space-x-3 rounded-md'>
                            ...
                            <span className='text-lg font-caviar font-bold tracking-wider'>Privacy Policy</span>
                        </Link>
