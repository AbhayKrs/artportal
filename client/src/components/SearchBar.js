    ...
    return (
        <div className="ml-auto col-12 align-middle items-center justify-content-center flex space-x-2">
            <div className="relative flex text-gray-300 dark:text-gray-600 w-full">
                ...
                <button disabled={props.searchValue.length === 0} type="submit" onClick={() => props.handleSubmit()} className="absolute bg-violet-400 text-black dark:text-white right-0 top-0 h-full px-3 rounded-r-lg">
                    <BiSearch />
                </button>
            </div>
        </div>
