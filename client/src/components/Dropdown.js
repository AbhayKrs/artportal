    ...
    return (
        <div className="relative w-fit inline-block text-left z-10">
            ...
            <div style={dropMenu ? { opacity: 1, transform: 'translate(0) scale(1)', visibility: 'visible' } : {}} className="opacity-0 invisible transition-all duration-300 transform origin-top-right -translate-y-2 scale-95">
                <div className={`absolute scrollbar max-h-[20em] w-56 overflow-auto mt-2 ${props.right && `right-0`} ${props.left && `left-0`} origin-top-right bg-white dark:bg-neutral-900 divide-y divide-gray-100 rounded-md shadow-lg outline-none`} aria-labelledby="headlessui-menu-button-1" id="headlessui-menu-items-117" role="menu">
