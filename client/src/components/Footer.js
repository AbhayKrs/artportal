...
const Footer = () => {
    return (
        <footer className="bg-slate-300 dark:bg-darkNavBg w-full shadow-[0_-4px_3px_rgba(175,175,175,0.55),_0_-2px_2px_rgba(175,175,175,0.5)] dark:shadow-[0_-4px_3px_rgba(45,45,45,0.55),_0_-2px_2px_rgba(45,45,45,0.5)]">
            ...
            <div className="md:hidden sm:block">
                <div className="items-center mx-2 p-1 flex flex-wrap flex-col sm:flex-row">
                    <div className='flex'>
                        <img className='h-10 w-auto hover:cursor-pointer' src={Artyst_icon} alt='Artyst' />
                    </div>
