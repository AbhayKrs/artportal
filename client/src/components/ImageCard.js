            ...
            <div className="hidden items-end h-full w-full group-hover:flex group-hover:flex-row">
                <div className="flex flex-col w-full pb-2 pt-14 px-2 bg-gradient-to-t from-black text-gray-200 group-hover:flex" >
                    ...
                    <div className="flex flex-row justify-between">
                        ...
                        <button onClick={() => navigate(`/explore/${props.explore.id}`)} className="w-5 h-5 bg-gray-200 text-gray-900 rounded-full hover:bg-gray-300 active:shadow-lg shadow transition ease-in duration-200 focus:outline-none">
