        ...
        <div className='flex flex-col col-span-3 p-2'>
            ...
            <div className='flex flex-col gap-2 py-4 px-6'>
                ...
                <div className=''>
                    ...
                    <h6 className='text-lg font-josefinlight text-gray-500 dark:text-gray-400'>Pick your preferred language to view the website.</h6>
                    <div className='flex py-2 px-4'>
                        <ul id='tabSlider' className="flex space-x-2 items-center">
                            {langList.map((lang, index) => {
                                return <li key={index} onClick={() => setActiveLang(index)} className={index === activeLang ? "font-parkinsans text-sm font-bold tracking-wider text-gray-700 bg-violet-300 rounded-lg h-fit shadow" : "font-parkinsans text-sm font-bold tracking-wider text-gray-700 dark:text-gray-400 bg-slate-200 dark:bg-neutral-900 flex items-center shadow cursor-pointer rounded-lg h-fit"}>
                ...
                <div className=''>
                    ...
                    {/* <button className="bg-gradient-to-r font-parkinsans font-semibold from-indigo-600 to-purple-400 mx-4 hover:scale-105 drop-shadow-md shadow-cla-blue px-4 py-1 rounded-lg">Setup</button> */}
                </div>
            </div>
        </div >
    )
