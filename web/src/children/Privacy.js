        ...
        <div className='flex flex-col gap-3 col-span-3 p-2 text-neutral-700 dark:text-gray-300'>
            ...
            <div className="space-y-6">
                <section className="flex flex-col gap-1">
                    ...
                    <p className="tracking-wide pl-5">This policy covers personal information of individuals, not corporate entities, and does not limit collection of exempted information like business contact or publicly available data.</p>
                </section>

                <section className="flex flex-col gap-1">
                    <h2 className="text-lg font-medium tracking-wide">2. Changes</h2>
                    <p className="tracking-wide pl-5">We may update this policy by posting changes on our website. Check regularly for updates.</p>
                </section>

                <section className="flex flex-col gap-1">
                    <h2 className="text-lg font-medium tracking-wide">3. Purposes</h2>
                    <p className="tracking-wide pl-5">We collect personal information (e.g., name, email, payment details, IP address) to:</p>
                    ...
                    <p className="tracking-wide pl-5">New purposes will be disclosed, and consent sought unless permitted by law.</p>
                </section>

                <section className="flex flex-col gap-1">
                    <h2 className="text-lg font-medium tracking-wide">4. Basis for Processing</h2>
                    <p className="tracking-wide pl-5">We process data based on:</p>
                    <ul className='list-disc pl-7'>
                ...
                <section className="flex flex-col gap-1">
                    ...
                    <p className="tracking-wide pl-5">Your data may be processed globally, including in the U.S., under safeguards like Standard Contractual Clauses for EU data. We share data with business partners, service providers, and authorities as needed.</p>
                </section>

                <section className="flex flex-col gap-1">
                    <h2 className="text-lg font-medium tracking-wide">6. Cookies</h2>
                    <p className="tracking-wide pl-5">We use cookies to enhance your experience. You can manage cookie settings in your browser, though this may limit site functionality.</p>
                </section>

                <section className="flex flex-col gap-1">
                    <h2 className="text-lg font-medium tracking-wide">7. Consent</h2>
                    <p className="tracking-wide pl-5">We won’t sell or rent your data without consent, except where legally permitted (e.g., public data, legal advice). You may withdraw consent with notice, which may affect service availability.</p>
                </section>

                <section className="flex flex-col gap-1">
                    <h2 className="text-lg font-medium tracking-wide">8. Data Limits</h2>
                    <p className="tracking-wide pl-5">We collect only necessary data, retain decision-related data for one year, and securely destroy unneeded data.</p>
                </section>

                <section className="flex flex-col gap-1">
                    <h2 className="text-lg font-medium tracking-wide">9. Accuracy</h2>
                    <p className="tracking-wide pl-5">We strive to keep data accurate. You can update your information or request corrections, which we’ll share with relevant third parties if needed.</p>
                </section>
