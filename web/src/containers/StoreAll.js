        ...
        <div className=' bg-gray-200 dark:bg-darkBg'>
            <div className='p-4 items-center'>
                <div className='flex sm:flex-row flex-col mb-3 justify-between'>
                    <div className='text-3xl  font-bold tracking-wider text-indigo-600 dark:text-indigo-600'>artportal Store</div>
                    <div className='flex items-center space-x-2'>
                        ...
                        <button onClick={() => navigate('/store/new')} className='ml-auto h-fit tracking-wider border-2 border-indigo-600 text-indigo-600  font-bold py-1.5 px-3 rounded-lg'>Create Listing</button>
