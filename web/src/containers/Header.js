...
const Header = ({ betaMsg, setBetaMsg }) => {
    ...
    return (
        <nav className='fixed top-0 z-50 bg-slate-200 w-full dark:bg-darkBg'>
            {betaMsg && <div className='relative flex flex-row w-full py-1.5 justify-center bg-amber-500 font-nunito font-bold text-xs tracking-wide'>
            ...
            <div className='flex flex-row items-center py-2 px-3 justify-between'>
                <div className='flex flex-row space-x-6'>
                    ...
                    <Link to='/explore' className='relative group hidden sm:flex self-center text-neutral-800 dark:text-gray-300 rounded-md text-base font-caviar font-bold tracking-wide'>
                        Explore
                    ...
                    <Link to='/store' className='relative group hidden sm:flex self-center text-neutral-800 dark:text-gray-300 rounded-md text-base font-caviar font-bold tracking-wide'>
                        Store
                                    ...
                                    <div className='flex flex-row items-center space-x-2 p-4'>
                                        ...
                                        <div className='flex flex-col'>
                                            ...
                                            <div className='inline-flex flex-row items-center gap-1'>
                                                <p className='text-gray-900 dark:text-gray-200 text-xs font-nunito font-bold tracking-wide'>#{user.username}</p>
                                    ...
                                    <div className='flex flex-row justify-between items-center rounded-md py-1 px-4'>
                                        <div className='flex flex-row gap-2 items-center'>
                                            ...
                                            <div>
                                                ...
                                                <p className='font-nunito items-center font-bold dark:font-normal text-gray-900 dark:text-gray-300'>{user.tokens} tokens</p>
                                            </div>
                                        </div>
