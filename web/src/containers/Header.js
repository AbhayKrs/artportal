        ...
        <nav className='fixed h-20 top-0 z-50 bg-slate-200 w-full dark:bg-darkBg'>
            ...
            <div className='flex flex-row items-center py-2 px-3 justify-between'>
                <div className='flex flex-row space-x-6'>
                    ...
                    <Link to='/explore' className='relative group hidden sm:flex self-center text-neutral-800 dark:text-gray-300 rounded-md text-lg  font-medium tracking-wide'>
                        Explore
                        <div className={`absolute ${activeRoute.includes('/explore') ? 'block' : 'hidden group-hover:block'} h-1 w-2/6 bottom-[-4px] left-0 rounded text-2xl bg-indigo-600 dark:bg-indigo-600`}></div>
                    </Link>
                    <Link to='/store' className='relative group hidden sm:flex self-center text-neutral-800 dark:text-gray-300 rounded-md text-lg  font-medium tracking-wide'>
                        Store
