            ...
            <div className="relative m-auto bg-slate-200 dark:bg-neutral-800 xs:w-11/12 sm:w-8/12 lg:w-6/12 rounded-xl z-50 overflow-y-auto">
                <div className='flex flex-col my-10 mx-auto gap-4 xs:w-10/12 md:w-8/12'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <p className=" text-base font-normal text-neutral-700 dark:text-gray-100/50">Don't have an account? <span className='font-semibold text-indigo-600 tracking-wide cursor-pointer' onClick={() => { onClose(); openRegister() }}>Sign up</span></p>
                    </div>
                    ...
                    <button onClick={onSubmitClick} className='w-fit  font-bold text-lg tracking-wide bg-indigo-600 hover:bg-indigo-600/75 text-gray-200 px-6 py-1 rounded-md'>Sign In</button>
        ...
        <div className={`${open ? 'block' : 'hidden'} flex fixed w-full inset-0 z-50 overflow-hidden justify-center items-center animated fadeIn faster`} style={{ background: 'rgba(0, 0, 0, .7)' }}>
            <div className="relative m-auto bg-slate-200 dark:bg-neutral-800 xs:w-11/12 sm:w-8/12 lg:w-6/12 rounded-xl z-50 overflow-y-auto">
                <div className='flex flex-col my-10 mx-auto gap-4 xs:w-10/12 md:w-8/12'>
                    ...
                    <div className='flex flex-col'>
                        <h1 className=" text-4xl font-bold text-neutral-800 dark:text-gray-300">{title}</h1>
                        <p className=" text-base font-normal text-neutral-700 dark:text-gray-100/50">Have an account already? <span className='font-semibold text-indigo-600 tracking-wide cursor-pointer' onClick={() => { onClose(); openLogin() }}>Sign in</span></p>
                    </div>
                    <div className="relative flex items-center">
                        <input
                            name="name"
                    ...
                    <div className='flex space-x-2 pt-5'>
                        <button onClick={onSubmitClick} className='w-fit  font-bold text-lg tracking-wide bg-indigo-600 hover:bg-indigo-600/75 text-gray-200 px-6 py-1 rounded-md'>Sign Up</button>
            ...
            <div className="relative m-auto xs:m-5 bg-slate-100 dark:bg-neutral-800 max-w-11/12 rounded-xl z-50 overflow-y-auto">
                <div className='grid'>
                    <div className='p-4 pt-2 flex flex-col space-y-3'>
                        ...
                        <h1 className='text-indigo-600 dark:text-indigo-800 text-4xl font-semibold tracking-widest '>{title}</h1>
                    ...
                    <div className='p-4 flex flex-col'>
                        ...
                        {/* <ul className='py-2 px-5 space-y-2 text-gray-700 dark:text-gray-400'>
                            <li className='flex justify-between place-items-center'>
                                ...
                                <button onClick={() => setPurchaseDialog({ open: true, value: 250, price: 100 })} className='w-20 bg-indigo-600/75 text-gray-900 dark:text-gray-200 hover:bg-indigo-600 dark:hover:bg-indigo-600 p-2 rounded-md text-sm  font-bold dark:font-normal'>&#8377;100</button>
                            </li>
                            <li className='flex justify-between place-items-center'>
                                <div className='text-lg '>500 tokens</div>
                                <button onClick={() => setPurchaseDialog({ open: true, value: 500, price: 190 })} className='w-20 bg-indigo-600/75 text-gray-900 dark:text-gray-200 hover:bg-indigo-600 dark:hover:bg-indigo-600 p-2 rounded-md text-sm  font-bold dark:font-normal'>&#8377;190</button>
                            </li>
                            <li className='flex justify-between place-items-center'>
                                <div className='text-lg '>1000 tokens</div>
                                <button onClick={() => setPurchaseDialog({ open: true, value: 1000, price: 360 })} className='w-20 bg-indigo-600/75 text-gray-900 dark:text-gray-200 hover:bg-indigo-600 dark:hover:bg-indigo-600 p-2 rounded-md text-sm  font-bold dark:font-normal'>&#8377;360</button>
                            </li>
                            <li className='flex justify-between place-items-center'>
                                <div className='text-lg '>5000 tokens</div>
                                <button onClick={() => setPurchaseDialog({ open: true, value: 5000, price: 1500 })} className='w-20 bg-indigo-600/75 text-gray-900 dark:text-gray-200 hover:bg-indigo-600 dark:hover:bg-indigo-600 p-2 rounded-md text-sm  font-bold dark:font-normal'>&#8377;1500</button>
                            </li>
                            <li className='flex justify-between place-items-center'>
                                <div className='text-lg '>10000 tokens</div>
                                <button onClick={() => setPurchaseDialog({ open: true, value: 10000, price: 2600 })} className='w-20 bg-indigo-600/75 text-gray-900 dark:text-gray-200 hover:bg-indigo-600 dark:hover:bg-indigo-600 p-2 rounded-md text-sm  font-bold dark:font-normal'>&#8377;2600</button>
                            </li>
                            <li className='flex justify-between place-items-center'>
                                <div className='text-lg '>25000 tokens</div>
                                <button onClick={() => setPurchaseDialog({ open: true, value: 25000, price: 5000 })} className='w-20 bg-indigo-600/75 text-gray-900 dark:text-gray-200 hover:bg-indigo-600 dark:hover:bg-indigo-600 p-2 rounded-md text-sm  font-bold dark:font-normal'>&#8377;5000</button>
                            </li>
                            <li className='flex justify-between place-items-center'>
                                <div className='text-lg '>50000 tokens</div>
                                <button onClick={() => setPurchaseDialog({ open: true, value: 50000, price: 7400 })} className='w-20 bg-indigo-600/75 text-gray-900 dark:text-gray-200 hover:bg-indigo-600 dark:hover:bg-indigo-600 p-2 rounded-md text-sm  font-bold dark:font-normal'>&#8377;7400</button>
                            </li>
                        </ul>
                        ...
                        <div className='flex flex-row justify-between'>
                            ...
                            <button className='whitespace-nowrap text-center bg-indigo-600/75 text-gray-900 dark:text-gray-200 hover:bg-indigo-600 dark:hover:bg-indigo-600 py-1 px-4 rounded-md  font-bold dark:font-normal'>Go Premium</button>
                        </div> */}
                    </div>
                </div>
            </div>
        ...
        <div className={`${open ? 'block' : 'hidden'} flex  fixed w-full inset-0 z-50 overflow-hidden justify-center items-center animated fadeIn faster`} style={{ background: 'rgba(0, 0, 0, .7)' }}>
            <div className="relative m-auto bg-slate-100 dark:bg-neutral-800 md:w-4/12 sm:w-8/12 xs:w-11/12 rounded-xl z-50 overflow-y-auto">
                <div className='grid'>
                    <div className='p-4 flex flex-col'>
                        <IoCloseSharp onClick={onClose} className='w-7 h-7 absolute top-0 right-0 mt-2 mr-2 cursor-pointer text-gray-400' />
                        <h1 className='text-indigo-600 dark:text-indigo-800 text-3xl font-semibold tracking-wide '>Add {new Intl.NumberFormat().format(value)} tokens</h1>
        ...
        <div className={`${open ? 'block' : 'hidden'} flex fixed w-full inset-0 z-50 overflow-hidden justify-center items-center animated fadeIn faster`} style={{ background: 'rgba(0, 0, 0, .7)' }}>
            <div className="scrollbar relative m-auto bg-slate-100 dark:bg-neutral-800 lg:w-8/12 sm:w-11/12 xs:w-11/12 h-full max-h-[90%] rounded-xl z-50 overflow-y-auto">
                <div className='p-4 h-full flex flex-col'>
                    <IoCloseSharp onClick={onClose} className='w-7 h-7 absolute top-0 right-0 mt-2 mr-2 cursor-pointer text-gray-400' />
                    <h1 className='text-indigo-600 dark:text-indigo-600 text-5xl font-semibold tracking-widest '>Cart</h1>
        ...
        <div className={`${open ? 'block' : 'hidden'} flex  fixed w-full inset-0 z-50 overflow-hidden justify-center items-center animated fadeIn faster`} style={{ background: 'rgba(0, 0, 0, .7)' }}>
            <div className="relative m-auto bg-slate-100 dark:bg-neutral-800 sm:w-8/12 xs:w-11/12 rounded-xl z-50 overflow-y-auto">
                <div className='grid'>
                    <div className='p-4 flex flex-col'>
                        <IoCloseSharp onClick={onClose} className='w-7 h-7 absolute top-0 right-0 mt-2 mr-2 cursor-pointer text-gray-400' />
                        <h1 className='text-indigo-600 dark:text-indigo-800 text-3xl font-semibold tracking-wide '>{title}</h1>
                        <div className='flex flex-col space-y-3 py-2 px-4'>
                            ...
                            <hr />
                            <button disabled={linkCopy} onClick={() => copyLink()} className='w-fit bg-indigo-600 text-gray-900 dark:text-gray-200 hover:bg-indigo-600 dark:hover:bg-indigo-600 px-3 py-1 rounded-md text-lg  font-bold dark:font-normal'>{!linkCopy ? 'Copy the link url' : 'Link Copied!'}</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="relative m-auto bg-slate-100 dark:bg-neutral-800 md:w-4/12 sm:w-8/12 xs:w-11/12 rounded-xl z-50 overflow-y-auto">
                <div className='grid'>
                    <div className='p-4 flex flex-col items-center'>
                        <h1 className='text-indigo-600 dark:text-indigo-800 text-xl font-semibold tracking-wide '>{title}</h1>
                        <div className='flex space-x-4 mt-3'>
                            <button onClick={onClose} className='text-white dark:text-indigo-600 bg-gray-600 dark:bg-gray-200 hover:text-indigo-600 dark:hover:text-indigo-600 px-4 py-2 rounded-md  font-bold dark:font-normal'>Cancel</button>
                            <button onClick={() => { onConfirm(); onClose() }} className='bg-indigo-600 text-gray-900 dark:text-gray-200 hover:bg-indigo-600 dark:hover:bg-indigo-600 px-4 py-2 rounded-md  font-bold dark:font-normal'>Confirm</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className='grid'>
                    <div className='p-4 flex flex-col items-center'>
                        ...
                        <div className='flex items-center mt-3'>
                            <button onClick={onClose} className='text-white dark:text-indigo-600 bg-gray-600 dark:bg-gray-200 hover:text-indigo-600 dark:hover:text-indigo-600 px-4 py-2 rounded-md  font-bold dark:font-normal'>Close</button>
                        </div>
                    </div>
                </div>
            </div>
