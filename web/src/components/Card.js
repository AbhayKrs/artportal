...
export const ImageCard = ({ size, artwork, artist }) => {
    ...
    return (
        <div className={`group flex relative cursor-pointer ${size === 'l' ? 'h-44 w-auto' : 'h-36 w-auto'}`} onClick={() => navigate(`/artwork/${artwork._id}`)}>
...
export const HorizontalCard = ({ artwork, artist }) => {
    ...
    return (
            ...
            <div className='flex flex-col absolute right-0 h-full w-[60%] rounded-r-lg text-gray-700 dark:text-gray-300 backdrop-sepia-0 bg-slate-300/75 dark:bg-neutral-700/25' style={{ clipPath: 'polygon(17% 0%, 100% 0%, 100% 100%, 0% 100%)' }}>
                <div className='flex flex-col max-w-[85%] h-full w-full p-4 absolute inset-y-0 right-0 m-auto justify-between'>
                    ...
                    <div className="flex flex-row justify-between">
                        ...
                        <BsInfoCircleFill onClick={() => navigate(`/artwork/${artwork._id}`)} className="cursor-pointer ml-auto h-5 w-5" />
                    </div>
                </div>
            </div>
        </div>
        ...
        //                     </div>
        //                 </div>
        //                 <button onClick={() => navigate(`/artwork/${artwork._id}`)} className="w-5 h-5 bg-gray-200 text-gray-900 rounded-full hover:bg-gray-300 active:shadow-lg shadow transition ease-in duration-200 focus:outline-none">
