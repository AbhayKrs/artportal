        ...
        <div className='relative flex xs:w-9/12 md:w-5/12 lg:w-6/12 text-gray-300 dark:text-gray-600 items-center'>
            ...
            >
                ...
                <input
                    ...
                    placeholder="Search..."
                    autoComplete="off"
                    className="w-full font-parkinsans font-normal tracking-wide bg-transparent text-neutral-800 dark:text-gray-200 placeholder-gray-600 dark:placeholder-gray-100/30 h-8 text-base focus:outline-none"
