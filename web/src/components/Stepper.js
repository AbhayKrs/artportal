    ...
    return (
        <div>
            <div className="flex py-4 items-center gap-2">
                <div className="flex flex-col items-center text-teal-600 relative gap-1">
                ...
                <div className="flex flex-col items-center text-white relative gap-1">
                ...
                <div className="flex flex-col items-center text-gray-500 relative gap-1">
