...
import { appPath, publicUrlOrPath, yarnLockFile, appHtml, appIndexJs, appPackageJson, appTsConfig, appPublic } from '../config/paths';
...
if (process.env.HOST) {
  ...
  console.log(
    `Learn more here: ${yellow('https://cra.link/advanced-config')}`
  );
  console.log();
}
